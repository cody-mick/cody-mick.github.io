...
//             <p>${hike.difficulty}</p>
//         </div>
//         <button id="more${hike.name}">More...</button>
//         </div>
//         </div>`;
...
//         <div>
//             <textarea id="comment${hike.name}"></textarea>
//             <button id="submitCom${hike.name}">Submit Comment</button>
//         </div>
//           `;
//           document.querySelector(".hidden").classList.remove("hidden");
//           document.getElementById(hike.name).innerHTML = item.innerHTML;
// }
